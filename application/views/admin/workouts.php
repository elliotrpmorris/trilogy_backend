        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h4>
              ...
              <button class="btn btn-outline-default btn-rounded btn-icon" data-position="bottom-right"><i class="mdi mdi mdi-dumbbell"></i></button> Workouts

            </h4>

            <nav aria-label="breadcrumb">

              <a type="button" href="<?php echo site_url('admin/workout/addnewexcercise'); ?>" data-id="0" class="btn btn-outline-primary btn-icon-text btn-xl addUpdateWorkoutTypes"><i class="mdi mdi-dumbbell btn-icon-prepend"></i> Add New Workouts</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><?php echo $val->day_no; ?></td>
                              <td><?php echo $val->workout_level_name; ?></td>
                              <td><?php echo $val->workout_title; ?></td>
                              ...
                              <td>
                              <a href="<?php echo site_url('admin/workout/updateexcercise/' . $val->id); ?>" class="btn btn-xs btn-inverse-primary btn-icon addUpdateWorkoutTypes">
                                  <i class="mdi mdi-border-color"></i>
                                </a>
                              </td>
                              <td>
                                <a href="<?php echo base_url(); ?>admin/workout/duplicateexcercise/<?php echo $edit_id; ?>" class="btn btn-xs btn-inverse-success btn-icon">
                                  <i class="mdi mdi-content-duplicate"></i>
                                </a>
                              </td>
                              <td><a href="<?php echo site_url('admincontrl/workout/deleteexcercise/' . $val->id); ?>" class="btn btn-sm btn-rounded btn-inverse-danger btn-icon" onclick="return confirm('Are you sure want to delete this record?');">

      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h3 class="page-title"><i class="mdi mdi-dumbbell"></i> Add / Update Workout</h3>
          ...
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <form id="workoutFrm" name="workoutFrm" action="#" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="card" style="border-radius: border: 2px; padding: 10px; border-radius: 10px;">
                          ...
                          <p class="title-text">Workout Info</p>
                          <hr>
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="workout_title" id="workout_title" placeholder="Title" value="<?php echo (isset($resultLog->workout_title) && $resultLog->workout_title != "") ? $resultLog->workout_title : ''; ?>" required>
                            ...
                            <div class="form-group">
                              ...
                              <textarea type="text" class="form-control" id="workout_tipe" name="workout_tipe" placeholder="Enter Description" row="5" autocomplete="off"><?php echo (isset($resultLog->workout_tipe) && $resultLog->workout_tipe != "") ? $resultLog->workout_tipe : ''; ?></textarea>
                            ...
                            <div class="form-group">
                              ...
                              <textarea type="text" class="form-control ckeditor" id="workout_desc" name="workout_desc" placeholder="Enter Description" row="5" autocomplete="off"><?php echo (isset($resultLog->workout_desc) && $resultLog->workout_desc != "") ? $resultLog->workout_desc : ''; ?></textarea>
                      ...
                      <div class="col-md-4">
                        <div class="card" style="border-radius: border: 2px; padding: 10px; border-radius: 10px;">
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              <select type="text" name="routine_id" id="routine_id" class="form-control" required autocomplete="off">
                                <option value="">Select one</option>
                                <?php
                                if (isset($routineLog) && !empty($routineLog)) {
                                  foreach ($routineLog as $key => $val) {
                                ?>
                                    <option value="<?php echo $val->id; ?>" <?php echo (isset($resultLog->routine_id) && $resultLog->routine_id == $val->id) ? 'selected' : ''; ?>><?php echo $val->title; ?></option>
                                <?php
                                  }
                                }
                                ?>
                        ...
                        <?php /* ?><div class="card" style="border-radius: border: 2px; padding: 10px; border-radius: 10px;">
                          ...
                          <p class="title-text">Select Coach</p>
                          <hr>

                          <div class="card-body">

                            <div class="form-group">
                              <select type="text" name="coach_id" id="coach_id" class="form-control" autocomplete="off">
                                <option value="">Select one</option>
                                <?php
                                if (isset($coachLog) && !empty($coachLog)) {
                                  foreach ($coachLog as $key => $val) {
                                ?>
                                    <option value="<?php echo $val->id; ?>" <?php echo (isset($resultLog->coach_id) && $resultLog->coach_id == $val->id) ? 'selected' : ''; ?>><?php echo $val->workout_coach_name; ?></option>
                                <?php
                                  }
                                }
                                ?>
                        ...
                        <div class="card" style="border-radius: border: 2px; padding: 10px; border-radius: 10px;">
                          ...
                          <div class="card-body">
                            ...
                            <?php if (isset($resultLog->workout_image_thumb) && $resultLog->workout_image_thumb != '') { ?>
                              <img src="<?php echo site_url($resultLog->workout_image_thumb) ?>">
                            <?php } ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#workoutFrm').submit(function() {
        ...
        $('#loader').show();
        $.ajax({
          url: "<?php echo base_url(); ?>/admincontrl/workout/addUpdateWorkoutData",
          ...
          success: function(value) {
            ...
            if (data.status == 1) {
              ...
              setTimeout(function() {
                window.location.href = '<?php echo base_url() ?>/admin/workout';
              }, 3000);

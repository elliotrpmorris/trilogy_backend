        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h4>
              ...
              <button class="btn btn-outline-default btn-rounded btn-icon" data-position="bottom-right"><i class="mdi mdi mdi-dumbbell"></i></button> Coach

            </h4>

            <nav aria-label="breadcrumb">

              <a type="button" href="<?php echo site_url('admin/workout/addcoach'); ?>" data-id="0" class="btn btn-outline-primary btn-icon-text btn-xl addUpdateWorkoutTypes"><i class="mdi mdi-dumbbell btn-icon-prepend"></i> Add New</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><img src="<?php echo site_url($val->coach_image); ?>" width="100"></td>
                              <td><?php echo $val->workout_coach_name; ?></td>
                              <td>
                              ...
                              <td>
                              <a href="<?php echo site_url('admin/workout/updatecoach/' . $val->id); ?>" class="btn btn-xs btn-inverse-primary btn-icon addUpdateWorkoutTypes">
                                  <i class="mdi mdi-border-color"></i>
                                </a>
                              </td>
                              <td><a href="<?php echo site_url('admincontrl/workout/deletecoach/' . $val->id); ?>" class="btn btn-sm btn-rounded btn-inverse-danger btn-icon" onclick="return confirm('Are you sure want to delete this record?');">

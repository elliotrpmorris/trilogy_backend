      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h3 class="page-title"><i class="mdi mdi-dumbbell"></i> Add / Update Workout Program Name</h3>
            ...
            <nav aria-label="breadcrumb">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Add / Workout Program</li>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#routineFrm').submit(function() {
        ...
        $('#loader').show();
        $.ajax({
          url: "<?php echo base_url(); ?>/admincontrl/workout/addUpdateRoutineData",
          ...
          success: function(value) {
            ...
            if (data.status == 1) {
              ...
              setTimeout(function() {
                window.location.href = '<?php echo base_url() ?>/admin/workout/routine';
              }, 3000);

        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h4>
              ...
              <button class="btn btn-outline-default btn-rounded btn-icon" data-position="bottom-right"><i class="mdi mdi mdi-dumbbell"></i></button> Workout Types Management

            </h4>

            <nav aria-label="breadcrumb">

              <a type="button" href="JavaScript:void(0)" data-id="0" class="btn btn-outline-primary btn-icon-text btn-xl addUpdateWorkoutTypes"><i class="mdi mdi-dumbbell btn-icon-prepend"></i> Add New</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><?php echo $val->workout_type; ?></td>
                              <td>
                              ...
                              <td>
                                <a href="JavaScript:void(0)" data-id="<?php echo $edit_id; ?>" class="btn btn-xs btn-inverse-primary btn-icon addUpdateWorkoutTypes">
                                  <i class="mdi mdi-border-color"></i>
                                </a>
                              </td>
                              <td><a href="<?php echo site_url('admincontrl/workoutmaster/deleteWorkoutTypes/' . $val->id); ?>" class="btn btn-sm btn-rounded btn-inverse-danger btn-icon" onclick="return confirm('Are you sure want to delete this record?');">
...
<div class="modal" id="addWorkoutTypes" tabindex="-1">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h6 class="modal-title" id="exampleModalLongTitle">Add / Update Workout Types</h6>
      ...
      <form action="#" method="post" id="workoutTypeFrm" name="workoutTypeFrm" enctype="multipart/form-data">
        <input type="hidden" name="id" id="typeid" value="0">
        <div class="modal-body">
          <span id="errorMsg"></span>
          <div class="form-group">

            <label for="exampleInputUsername1">Workout Type</label> <i class="text-danger">*</i>

            <input type="text" class="form-control" placeholder="Enter Workout Type" id="workout_type" name="workout_type" autocomplete="off" required>

...
class PaymentProcessorService {
	 ...
	 * @return \TrustPayments\Sdk\Model\PaymentProcessor[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\TrustPayments\Sdk\Model\PaymentProcessor[]', $response->getHeaders()));

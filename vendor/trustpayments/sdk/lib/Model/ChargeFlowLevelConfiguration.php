...
class ChargeFlowLevelConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'flow' => '\TrustPayments\Sdk\Model\ChargeFlow',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => 'string',
        'period' => 'string',
     ...
     * Sets flow
     *
     * @param \TrustPayments\Sdk\Model\ChargeFlow $flow The charge flow level configuration to which the flow is associated.
     *
     * @return $this
     */

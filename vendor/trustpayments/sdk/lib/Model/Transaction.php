...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'authorization_environment' => '\TrustPayments\Sdk\Model\ChargeAttemptEnvironment',
        'authorization_sales_channel' => 'int',
        'authorization_timeout_on' => '\DateTime',
        'authorized_on' => '\DateTime',
        'auto_confirmation_enabled' => 'bool',
        'billing_address' => '\TrustPayments\Sdk\Model\Address',
        ...
        'customer_id' => 'string',
        'customers_presence' => '\TrustPayments\Sdk\Model\CustomersPresence',
        'delivery_decision_made_on' => '\DateTime',
        'device_session_identifier' => 'string',
        'emails_disabled' => 'bool',
        'end_of_life' => '\DateTime',
        'environment' => '\TrustPayments\Sdk\Model\Environment',
        'environment_selection_strategy' => '\TrustPayments\Sdk\Model\TransactionEnvironmentSelectionStrategy',
        'failed_on' => '\DateTime',
        'failed_url' => 'string',
        'failure_reason' => '\TrustPayments\Sdk\Model\FailureReason',
        'group' => '\TrustPayments\Sdk\Model\TransactionGroup',
        'id' => 'int',
        ...
        'java_enabled' => 'bool',
        'language' => 'string',
        'line_items' => '\TrustPayments\Sdk\Model\LineItem[]',
        'linked_space_id' => 'int',
        'merchant_reference' => 'string',
        'meta_data' => 'map[string,string]',
        'parent' => 'int',
        'payment_connector_configuration' => '\TrustPayments\Sdk\Model\PaymentConnectorConfiguration',
        ...
        'screen_width' => 'string',
        'shipping_address' => '\TrustPayments\Sdk\Model\Address',
        'shipping_method' => 'string',
        'space_view_id' => 'int',
        'state' => '\TrustPayments\Sdk\Model\TransactionState',
        'success_url' => 'string',
        'terminal' => '\TrustPayments\Sdk\Model\PaymentTerminal',
        'time_zone' => 'string',
        'token' => '\TrustPayments\Sdk\Model\Token',
        'tokenization_mode' => '\TrustPayments\Sdk\Model\TokenizationMode',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'user_agent_header' => 'string',
        'user_failure_message' => 'string',
        'user_interface_type' => '\TrustPayments\Sdk\Model\TransactionUserInterfaceType',
        'version' => 'int',
     ...
     *
     * @return \TrustPayments\Sdk\Model\ChargeAttemptEnvironment
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which this transaction was successfully authorized.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\Address
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\Address $billing_address 
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\TransactionCompletionBehavior
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TransactionCompletionBehavior $completion_behavior The completion behavior controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\CustomersPresence
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates what kind of authentication method was finally used during authorization of the transaction. If no value is provided, 'Virtually Present' is used by default.
     *
     * @return $this
     */
     ...
     * Gets environment
     *
     * @return \TrustPayments\Sdk\Model\Environment
     */
     ...
     * Sets environment
     *
     * @param \TrustPayments\Sdk\Model\Environment $environment 
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\TransactionEnvironmentSelectionStrategy
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The environment selection strategy determines how the environment (test or production) for processing the transaction is selected.
     *
     * @return $this
     */
     ...
     * Gets failure_reason
     *
     * @return \TrustPayments\Sdk\Model\FailureReason
     */
     ...
     * Sets failure_reason
     *
     * @param \TrustPayments\Sdk\Model\FailureReason $failure_reason The failure reason describes why the transaction failed. This is only provided when the transaction is marked as failed.
     *
     * @return $this
     */
     ...
     * Gets group
     *
     * @return \TrustPayments\Sdk\Model\TransactionGroup
     */
     ...
     * Sets group
     *
     * @param \TrustPayments\Sdk\Model\TransactionGroup $group 
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $line_items 
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\PaymentConnectorConfiguration
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\Address $shipping_address 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\TransactionState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\TransactionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets terminal
     *
     * @return \TrustPayments\Sdk\Model\PaymentTerminal
     */
     ...
     * Sets terminal
     *
     * @param \TrustPayments\Sdk\Model\PaymentTerminal $terminal The terminal on which the payment was processed.
     *
     * @return $this
     */
     ...
     * Gets token
     *
     * @return \TrustPayments\Sdk\Model\Token
     */
     ...
     * Sets token
     *
     * @param \TrustPayments\Sdk\Model\Token $token 
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\TokenizationMode
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode controls if and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\TransactionUserInterfaceType
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TransactionUserInterfaceType $user_interface_type The user interface type defines through which user interface the transaction has been processed resp. created.
     *
     * @return $this
     */

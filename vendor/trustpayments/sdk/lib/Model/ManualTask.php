...
class ManualTask implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'space_id' => 'int',
        'state' => '\TrustPayments\Sdk\Model\ManualTaskState',
        'type' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\ManualTaskState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\ManualTaskState $state The object's current state.
     *
     * @return $this
     */

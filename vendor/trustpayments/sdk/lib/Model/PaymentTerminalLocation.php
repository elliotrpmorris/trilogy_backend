...
class PaymentTerminalLocation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\TrustPayments\Sdk\Model\PaymentTerminalLocationState',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\PaymentTerminalLocationState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\PaymentTerminalLocationState $state The object's current state.
     *
     * @return $this
     */

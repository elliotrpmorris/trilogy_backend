...
class SubscriptionProductComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'component_group' => '\TrustPayments\Sdk\Model\SubscriptionProductComponentGroup',
        ...
        'quantity_step' => 'float',
        'reference' => '\TrustPayments\Sdk\Model\SubscriptionProductComponentReference',
        'sort_order' => 'int',
        'tax_class' => '\TrustPayments\Sdk\Model\TaxClass',
        'version' => 'int'
    ];
     ...
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionProductComponentGroup
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionProductComponentGroup $component_group 
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $description The component description may contain a longer description which gives the subscriber a better understanding of what the component contains.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $name The component name is shown to the subscriber. It should describe in few words what the component does contain.
     *
     * @return $this
     */
     ...
     * Gets reference
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionProductComponentReference
     */
     ...
     * Sets reference
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionProductComponentReference $reference The component reference is used to identify the component by external systems and it marks components to represent the same component within different product versions.
     *
     * @return $this
     */
     ...
     * Gets tax_class
     *
     * @return \TrustPayments\Sdk\Model\TaxClass
     */
     ...
     * Sets tax_class
     *
     * @param \TrustPayments\Sdk\Model\TaxClass $tax_class The tax class of the component determines the taxes which are applicable on all fees linked with the component.
     *
     * @return $this
     */

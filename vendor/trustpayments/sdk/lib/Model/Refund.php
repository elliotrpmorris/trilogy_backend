...
class Refund implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => 'float',
        'base_line_items' => '\TrustPayments\Sdk\Model\LineItem[]',
        'completion' => 'int',
        'created_by' => 'int',
        'created_on' => '\DateTime',
        ...
        'reduced_line_items' => '\TrustPayments\Sdk\Model\LineItem[]',
        'reductions' => '\TrustPayments\Sdk\Model\LineItemReduction[]',
        'state' => '\TrustPayments\Sdk\Model\RefundState',
        'succeeded_on' => '\DateTime',
        'taxes' => '\TrustPayments\Sdk\Model\Tax[]',
        'time_zone' => 'string',
        'timeout_on' => '\DateTime',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'transaction' => '\TrustPayments\Sdk\Model\Transaction',
        'type' => '\TrustPayments\Sdk\Model\RefundType',
        'updated_invoice' => 'int',
        'version' => 'int'
    ];
     ...
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $base_line_items 
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $reduced_line_items 
     *
     * @return $this
     */
     ...
     * Gets reductions
     *
     * @return \TrustPayments\Sdk\Model\LineItemReduction[]
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\RefundState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\RefundState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \TrustPayments\Sdk\Model\Tax[]
     */
     ...
     * Sets taxes
     *
     * @param \TrustPayments\Sdk\Model\Tax[] $taxes 
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \TrustPayments\Sdk\Model\RefundType
     */
     ...
     * Sets type
     *
     * @param \TrustPayments\Sdk\Model\RefundType $type 
     *
     * @return $this
     */

...
class SubscriptionProductVersion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'product' => '\TrustPayments\Sdk\Model\SubscriptionProduct',
        'reference' => 'string',
        'retiring_finished_on' => '\DateTime',
        'retiring_started_on' => '\DateTime',
        'state' => '\TrustPayments\Sdk\Model\SubscriptionProductVersionState',
        'tax_calculation' => '\TrustPayments\Sdk\Model\TaxCalculation',
        'version' => 'int'
    ];
     ...
     * Sets name
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $name The product version name is the name of the product which is shown to the user for the version. When the visible product name should be changed for a particular product a new version has to be created which contains the new name of the product.
     *
     * @return $this
     */
     ...
     * Sets product
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionProduct $product Each product version is linked to a product.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionProductVersionState
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\TaxCalculation
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TaxCalculation $tax_calculation Strategy that is used for tax calculation in fees.
     *
     * @return $this
     */

...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'postal_address' => '\TrustPayments\Sdk\Model\SpaceAddressCreate',
     ...
     * Gets postal_address
     *
     * @return \TrustPayments\Sdk\Model\SpaceAddressCreate
     */
     ...
     * Sets postal_address
     *
     * @param \TrustPayments\Sdk\Model\SpaceAddressCreate $postal_address The address to use in communication with clients for example in email, documents etc.
     *
     * @return $this
     */

...
class TransactionInvoice extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'completion' => '\TrustPayments\Sdk\Model\TransactionCompletion',
        'created_on' => '\DateTime',
        'derecognized_by' => 'int',
        ...
        'space_view_id' => 'int',
        'state' => '\TrustPayments\Sdk\Model\TransactionInvoiceState',
        'tax_amount' => 'float',
        'time_zone' => 'string',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\TransactionInvoiceState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\TransactionInvoiceState $state The object's current state.
     *
     * @return $this
     */

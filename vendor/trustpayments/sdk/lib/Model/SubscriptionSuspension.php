...
class SubscriptionSuspension implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'end_action' => '\TrustPayments\Sdk\Model\SubscriptionSuspensionAction',
        'id' => 'int',
        'language' => 'string',
        'linked_space_id' => 'int',
        'note' => 'string',
        ...
        'reason' => '\TrustPayments\Sdk\Model\SubscriptionSuspensionReason',
        'state' => '\TrustPayments\Sdk\Model\SubscriptionSuspensionState',
        'subscription' => 'int',
        'version' => 'int'
    ];
     ...
     * Gets end_action
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionSuspensionAction
     */
     ...
     * Sets end_action
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionSuspensionAction $end_action When the suspension reaches the planned end date the end action will be carried out. This action is only executed when the suspension is ended automatically based on the end date.
     *
     * @return $this
     */
     ...
     * Gets reason
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionSuspensionReason
     */
     ...
     * Sets reason
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionSuspensionReason $reason The suspension reason indicates why a suspension has been created.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionSuspensionState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionSuspensionState $state The object's current state.
     *
     * @return $this
     */

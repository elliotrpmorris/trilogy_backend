...
class Space implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'created_by' => 'int',
        'created_on' => '\DateTime',
        'database' => '\TrustPayments\Sdk\Model\TenantDatabase',
        'deleted_by' => 'int',
        'deleted_on' => '\DateTime',
        'id' => 'int',
        ...
        'postal_address' => '\TrustPayments\Sdk\Model\SpaceAddress',
     ...
     * Sets account
     *
     * @param \TrustPayments\Sdk\Model\Account $account The account to which the space belongs to.
     *
     * @return $this
     */
     ...
     * Gets database
     *
     * @return \TrustPayments\Sdk\Model\TenantDatabase
     */
     ...
     * Sets database
     *
     * @param \TrustPayments\Sdk\Model\TenantDatabase $database The database in which the space's data are stored in.
     *
     * @return $this
     */
     ...
     * Gets postal_address
     *
     * @return \TrustPayments\Sdk\Model\SpaceAddress
     */
     ...
     * Sets postal_address
     *
     * @param \TrustPayments\Sdk\Model\SpaceAddress $postal_address The address to use in communication with clients for example in email, documents etc.
     *
     * @return $this
     */

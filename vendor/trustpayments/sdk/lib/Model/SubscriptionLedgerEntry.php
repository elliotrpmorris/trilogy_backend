...
class SubscriptionLedgerEntry implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'quantity' => 'float',
        'state' => '\TrustPayments\Sdk\Model\SubscriptionLedgerEntryState',
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\SubscriptionLedgerEntryState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\SubscriptionLedgerEntryState $state The object's current state.
     *
     * @return $this
     */

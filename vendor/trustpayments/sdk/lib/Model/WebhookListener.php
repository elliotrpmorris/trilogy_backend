...
class WebhookListener implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'identity' => '\TrustPayments\Sdk\Model\WebhookIdentity',
        'linked_space_id' => 'int',
        'name' => 'string',
        'notify_every_change' => 'bool',
        'planned_purge_date' => '\DateTime',
        'state' => '\TrustPayments\Sdk\Model\CreationEntityState',
        'url' => '\TrustPayments\Sdk\Model\WebhookUrl',
        'version' => 'int'
    ];
     ...
     * Gets identity
     *
     * @return \TrustPayments\Sdk\Model\WebhookIdentity
     */
     ...
     * Sets identity
     *
     * @param \TrustPayments\Sdk\Model\WebhookIdentity $identity The identity which will be used to sign messages sent by this listener.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param \TrustPayments\Sdk\Model\WebhookUrl $url The URL which is invoked by the listener to notify the application about the event.
     *
     * @return $this
     */

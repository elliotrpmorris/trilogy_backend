...
class PaymentLinkUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'currency' => 'string',
        'language' => 'string',
        'line_items' => '\TrustPayments\Sdk\Model\LineItemCreate[]',
     ...
     * Sets line_items
     *
     * @param \TrustPayments\Sdk\Model\LineItemCreate[] $line_items The line items allows to define the line items for this payment link. When the line items are defined they cannot be overridden through the request parameters.
     *
     * @return $this
     */

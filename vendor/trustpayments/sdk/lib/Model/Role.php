...
class Role implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'permissions' => '\TrustPayments\Sdk\Model\Permission[]',
        'planned_purge_date' => '\DateTime',
        'state' => '\TrustPayments\Sdk\Model\RoleState',
     ...
     * Sets account
     *
     * @param \TrustPayments\Sdk\Model\Account $account The account to which this role belongs to. This role can only be assigned within the assigned account and the sub accounts of the assigned account.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $name The name of this role is used to identify the role within administrative interfaces.
     *
     * @return $this
     */
     ...
     * Gets permissions
     *
     * @return \TrustPayments\Sdk\Model\Permission[]
     */
     ...
     * Sets permissions
     *
     * @param \TrustPayments\Sdk\Model\Permission[] $permissions Set of permissions that are granted to this role.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\RoleState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\RoleState $state The object's current state.
     *
     * @return $this
     */

...
class PaymentLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'allowed_payment_method_configurations' => '\TrustPayments\Sdk\Model\PaymentMethodConfiguration[]',
        'applied_space_view' => 'int',
        'available_from' => '\DateTime',
        'available_until' => '\DateTime',
        'billing_address_handling_mode' => '\TrustPayments\Sdk\Model\PaymentLinkAddressHandlingMode',
        'currency' => 'string',
        'external_id' => 'string',
        'id' => 'int',
        'language' => 'string',
        ...
        'protection_mode' => '\TrustPayments\Sdk\Model\PaymentLinkProtectionMode',
        'shipping_address_handling_mode' => '\TrustPayments\Sdk\Model\PaymentLinkAddressHandlingMode',
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentMethodConfiguration[] $allowed_payment_method_configurations The allowed payment method configurations restrict the payment methods which can be used with this payment link.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\PaymentLinkAddressHandlingMode
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentLinkAddressHandlingMode $billing_address_handling_mode The billing address handling mode controls if the address is collected or not and how it is collected.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $line_items The line items allows to define the line items for this payment link. When the line items are defined they cannot be overridden through the request parameters.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\PaymentLinkProtectionMode
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentLinkProtectionMode $protection_mode The protection mode determines if the payment link is protected against tampering and in what way.
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentLinkAddressHandlingMode $shipping_address_handling_mode The shipping address handling mode controls if the address is collected or not and how it is collected.
     *
     * @return $this
     */

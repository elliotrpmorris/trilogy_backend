...
class EntityQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'filter' => '\TrustPayments\Sdk\Model\EntityQueryFilter',
        'language' => 'string',
        'number_of_entities' => 'int',
        'order_bys' => '\TrustPayments\Sdk\Model\EntityQueryOrderBy[]',
        'starting_entity' => 'int'
    ];
     ...
     * Sets filter
     *
     * @param \TrustPayments\Sdk\Model\EntityQueryFilter $filter The filter node defines the root filter node of the query. The root node may contain multiple sub nodes with different filters in it.
     *
     * @return $this
     */
     ...
     * Sets order_bys
     *
     * @param \TrustPayments\Sdk\Model\EntityQueryOrderBy[] $order_bys The order bys allows to define the ordering of the entities returned by the search.
     *
     * @return $this
     */

...
class LineItemCreate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attributes' => 'map[string,\TrustPayments\Sdk\Model\LineItemAttributeCreate]',
        'discount_including_tax' => 'float',
        'name' => 'string',
        'quantity' => 'float',
        'shipping_required' => 'bool',
        'sku' => 'string',
        'taxes' => '\TrustPayments\Sdk\Model\TaxCreate[]',
     ...
     * Gets attributes
     *
     * @return map[string,\TrustPayments\Sdk\Model\LineItemAttributeCreate]
     */
     ...
     * Sets attributes
     *
     * @param map[string,\TrustPayments\Sdk\Model\LineItemAttributeCreate] $attributes 
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \TrustPayments\Sdk\Model\TaxCreate[] $taxes 
     *
     * @return $this
     */

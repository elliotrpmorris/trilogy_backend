...
class TerminalReceiptFetchRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'format' => '\TrustPayments\Sdk\Model\TerminalReceiptFormat',
        'transaction' => 'int',
        'width' => 'int'
    ];
     ...
     * Gets format
     *
     * @return \TrustPayments\Sdk\Model\TerminalReceiptFormat
     */
     ...
     * Sets format
     *
     * @param \TrustPayments\Sdk\Model\TerminalReceiptFormat $format The format determines in what format the receipts will be returned in.
     *
     * @return $this
     */

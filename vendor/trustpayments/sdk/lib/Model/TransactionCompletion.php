...
class TransactionCompletion extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'line_item_version' => '\TrustPayments\Sdk\Model\TransactionLineItemVersion',
        'line_items' => '\TrustPayments\Sdk\Model\LineItem[]',
        'mode' => '\TrustPayments\Sdk\Model\TransactionCompletionMode',
        'next_update_on' => '\DateTime',
        'payment_information' => 'string',
        'planned_purge_date' => '\DateTime',
        'processing_on' => '\DateTime',
        'processor_reference' => 'string',
        'remaining_line_items' => '\TrustPayments\Sdk\Model\LineItem[]',
        'space_view_id' => 'int',
        'state' => '\TrustPayments\Sdk\Model\TransactionCompletionState',
     ...
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $base_line_items The base line items on which the completion is applied on.
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\TransactionLineItemVersion $line_item_version 
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $line_items The line items which are captured.
     *
     * @return $this
     */
     ...
     * Gets mode
     *
     * @return \TrustPayments\Sdk\Model\TransactionCompletionMode
     */
     ...
     * Sets mode
     *
     * @param \TrustPayments\Sdk\Model\TransactionCompletionMode $mode 
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\LineItem[] $remaining_line_items 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \TrustPayments\Sdk\Model\TransactionCompletionState
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\TransactionCompletionState $state The object's current state.
     *
     * @return $this
     */

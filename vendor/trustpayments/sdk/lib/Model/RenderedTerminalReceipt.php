...
class RenderedTerminalReceipt implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'mime_type' => 'string',
        'printed' => 'bool',
        'receipt_type' => '\TrustPayments\Sdk\Model\PaymentTerminalReceiptType'
    ];
     ...
     * Gets receipt_type
     *
     * @return \TrustPayments\Sdk\Model\PaymentTerminalReceiptType
     */
     ...
     * Sets receipt_type
     *
     * @param \TrustPayments\Sdk\Model\PaymentTerminalReceiptType $receipt_type Each receipt has a different usage. The receipt type indicates for what resp. for whom the document is for.
     *
     * @return $this
     */

...
class ProductMeteredTierFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fee' => '\TrustPayments\Sdk\Model\PersistableCurrencyAmount[]',
        'id' => 'int',
        'metered_fee' => '\TrustPayments\Sdk\Model\ProductMeteredFee',
        'start_range' => 'float',
        'version' => 'int'
    ];
     ...
     * Sets fee
     *
     * @param \TrustPayments\Sdk\Model\PersistableCurrencyAmount[] $fee The fee determines the amount which is charged. The consumed metric is multiplied by the defined fee. The resulting amount is charged at the end of the period.
     *
     * @return $this
     */
     ...
     * Sets metered_fee
     *
     * @param \TrustPayments\Sdk\Model\ProductMeteredFee $metered_fee 
     *
     * @return $this
     */

...
class ProductPeriodFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'ledger_entry_title' => '\TrustPayments\Sdk\Model\DatabaseTranslatedString',
        'linked_space_id' => 'int',
        'name' => '\TrustPayments\Sdk\Model\DatabaseTranslatedString',
        'number_of_free_trial_periods' => 'int',
        'period_fee' => '\TrustPayments\Sdk\Model\PersistableCurrencyAmount[]',
     ...
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $ledger_entry_title The ledger entry title will be used for the title in the ledger entry and in the invoice.
     *
     * @return $this
     */
     ...
     * Sets period_fee
     *
     * @param \TrustPayments\Sdk\Model\PersistableCurrencyAmount[] $period_fee The period fee is charged for every period of the subscription except for those periods which are trial periods.
     *
     * @return $this
     */

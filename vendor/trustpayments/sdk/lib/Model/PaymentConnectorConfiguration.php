...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'conditions' => 'int[]',
        'connector' => 'int',
        'enabled_sales_channels' => '\TrustPayments\Sdk\Model\SalesChannel[]',
        'enabled_space_views' => 'int[]',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => 'string',
        'payment_method_configuration' => '\TrustPayments\Sdk\Model\PaymentMethodConfiguration',
        'planned_purge_date' => '\DateTime',
        'priority' => 'int',
        'processor_configuration' => '\TrustPayments\Sdk\Model\PaymentProcessorConfiguration',
     ...
     *
     * @return \TrustPayments\Sdk\Model\SalesChannel[]
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\SalesChannel[] $enabled_sales_channels Defines the sales channels the connector configuration is enabled for. In case the set is empty, the connector configuration is enabled for all sales channels.
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentMethodConfiguration $payment_method_configuration 
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\PaymentProcessorConfiguration
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PaymentProcessorConfiguration $processor_configuration 
     *
     * @return $this
     */

...
class PaymentMethodConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'data_collection_type' => '\TrustPayments\Sdk\Model\DataCollectionType',
        'description' => '\TrustPayments\Sdk\Model\DatabaseTranslatedString',
        'id' => 'int',
        'image_resource_path' => '\TrustPayments\Sdk\Model\ModelResourcePath',
        'linked_space_id' => 'int',
        'name' => 'string',
        'one_click_payment_mode' => '\TrustPayments\Sdk\Model\OneClickPaymentMode',
        'payment_method' => 'int',
        ...
        'title' => '\TrustPayments\Sdk\Model\DatabaseTranslatedString',
        'version' => 'int'
    ];
     ...
     *
     * @return \TrustPayments\Sdk\Model\DataCollectionType
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\DataCollectionType $data_collection_type The data collection type determines who is collecting the payment information. This can be done either by the processor (offsite) or by our application (onsite).
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $description The payment method configuration description can be used to show a text during the payment process. Choose an appropriate description as it will be displayed to your customer.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\ModelResourcePath
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\ModelResourcePath $image_resource_path The image of the payment method configuration overrides the default image of the payment method.
     *
     * @return $this
     */
     ...
     *
     * @return \TrustPayments\Sdk\Model\OneClickPaymentMode
     */
     ...
     * Sets title
     *
     * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $title The title of the payment method configuration is used within the payment process. The title is visible to the customer.
     *
     * @return $this
     */

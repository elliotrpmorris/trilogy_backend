...
class ProductSetupFeeUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'on_downgrade_credited_amount' => '\TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'on_upgrade_credited_amount' => '\TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'setup_fee' => '\TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[]'
    ];
     ...
     *
     * @return \TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[]
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_downgrade_credited_amount When the subscription is changed and the change is considered as a downgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     *
     * @param \TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_upgrade_credited_amount When the subscription is changed and the change is considered as a upgrade the amount defined by this property will be credited to the subscriber.
     *
     * @return $this
     */
     ...
     * Sets setup_fee
     *
     * @param \TrustPayments\Sdk\Model\PersistableCurrencyAmountUpdate[] $setup_fee The setup fee is charged when the subscriber subscribes to this component. The setup fee is debited with the first charge for the subscriptions.
     *
     * @return $this
     */
